...
<head>
    <meta charset="utf-8">
    <title>Annaires - @yield('title')</title>
    ...
    <link href=" {{asset('pages/css/animate.min.css')}}" rel="stylesheet">
    <link href=" {{asset('pages/css/owl.carousel.min.css')}}" rel="stylesheet">
